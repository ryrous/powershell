...
####################################################
# FETCH CLIENT ID AND VERSION IF DATA EXISTS; OTHERWISE CREATE FILE
####################################################
...
####################################################
# CALL VERSION METHOD TO CHECK LATEST VERSION; PULL NEW DATA IF VERSION NUMBER IS DIFFERENT
####################################################
...
if ($version.latest -gt $lastVersion){
    ...
    Write-Host
    ####################################################
    # WRITE NEW VERSION NUMBER TO DATA FILE
    ####################################################
